      ...
      return (
        <nav className="nav-header">
          ...
          <div>
            ...
            <button className="login" onClick={() => this.props.openModal({action: 'login'})}>Log in</button>
            <button className="signup" onClick={() => this.props.openModal({action: 'signup'})}>Sign up</button>
          </div>
        </nav>
      );
    }
